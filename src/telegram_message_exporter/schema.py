...
POSTBOX_FIELD_ALIASES: dict[str, dict[str, str]] = {
    ...
    "TelegramMediaGiveaway": {
        "flg": "flags",
        "cns": "channel_peer_ids",
        "cnt": "countries",
        "qty": "quantity",
        "mts": "premium_months",
        "str": "stars_amount",
        "unt": "until_date",
        "des": "prize_description",
    },
    "TelegramMediaGiveawayResults": {
        "flg": "flags",
        "msgp": "launch_message_id_peer_id",
        "msgi": "launch_message_id",
        "chn": "additional_channels_count",
        "wnr": "winners_peer_ids",
        "wnc": "winners_count",
        "unc": "unclaimed_count",
        "mts": "premium_months",
        "str": "stars_amount",
    ...
    "TelegramMediaInvoice": {
        ...
        "m": "extended_media",
        "f": "flags",
        "r.p": "receipt_message_id_peer_id",
        "r.n": "receipt_message_id_namespace",
        "r.i": "receipt_message_id_id",
        "vrs": "version",
    },
    "TelegramMediaLiveStream": {
        "call": "call",
    ...
    "TelegramMediaMap": {
        ...
        "ve": "venue",
        "adr": "address",
        "bt": "live_broadcasting_timeout",
        "pnr": "live_proximity_notification_radius",
    },
    "MapVenue": {
        "ti": "title",
        "ad": "address",
    ...
    "TelegramMediaPoll": {
        ...
        "ph": "poll_hash",
        "oa": "open_answers",
        "rd": "revoting_disabled",
        "sa": "shuffle_answers",
        "hr": "hide_results_until_close",
        "cr": "is_creator",
        "am": "attached_media",
        "sub": "restrict_to_subscribers",
        "cnt": "countries",
    },
    "TelegramMediaPollKind": {
        "_v": "variant",
        "m": "multiple_answers",
    },
    "TelegramMediaPollOption": {
    ...
    "TelegramMediaPollResults": {
        ...
        "rv": "recent_voters",
        "sol": "solution_text",
        "solent": "solution_entities",
        "solmd": "solution_media",
        "uns": "has_unseen_votes",
        "cvs": "can_view_stats",
    },
    "VideoThumbnail": {
        "w": "width",
    ...
    "TelegramMediaAction": {
        ...
        "isRecurringInit": "is_recurring_init",
        "isRecurringUsed": "is_recurring_used",
        "ent": "entities",
        "do": "domain",
        "ty": "types",
        "fromId": "from_id",
        ...
        "savedToProfile": "saved_to_profile",
        "canUpgrade": "can_upgrade",
        "upgradeStars": "upgrade_stars",
        "isRefunded": "is_refunded",
        "isPrepaidUpgrade": "is_prepaid_upgrade",
        "upgradeMessageId": "upgrade_message_id",
        "savedId": "saved_id",
        "prepaidUpgradeHash": "prepaid_upgrade_hash",
        "giftMessageId": "gift_message_id",
        "upgradeSeparate": "upgrade_separate",
        "isAuctionAcquired": "is_auction_acquired",
        "toPeerId": "to_peer_id",
        "isUpgrade": "is_upgrade",
        "isTransferred": "is_transferred",
        "canExportDate": "can_export_date",
        "transferStars": "transfer_stars",
        "resaleAmount": "resale_amount",
        "resaleStars": "resale_stars",
        "canTransferDate": "can_transfer_date",
        "canResaleDate": "can_resale_date",
        "dropOriginalDetailsStars": "drop_original_details_stars",
        "fromOffer": "from_offer",
        "canCraftAt": "can_craft_at",
        "isCrafted": "is_crafted",
        "cid": "call_id",
        "dur": "duration",
        "part": "other_participants",
        "iui": "is_user_initiated",
        "brmsg": "broadcast_messages_allowed",
        ...
        "k": "kind",
        "botId": "bot_id",
        "giveawayMsgId": "giveaway_message_id",
    },
}
